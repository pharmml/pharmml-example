...
; Target	: NMTRAN 7.3.0
; Model 	: UseCase17
; Dated 	: Wed Dec 09 19:37:29 GMT 2015

$PROBLEM "generated by MDL2PharmML v.6.0"

$INPUT  ID TIME=TIME WT=DROP AGE=DROP SEX=DROP AMT SS II DVID DV MDV LOGTWT
$DATA "warfarin_conc_SS.csv" IGNORE=@
$SUBS ADVAN13 TOL=6
...
$TABLE  ID TIME AMT SS II DVID MDV LOGTWT PRED IPRED RES IRES WRES IWRES Y DV NOAPPEND NOPRINT FILE=sdtab
